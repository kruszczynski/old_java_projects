...
public class GUI {
	...
	public void go(){
		...
		formatJCB[1].addActionListener(new JCBTwoActionListener());
		...
		temp = new JPanel();
		errorsArea = new JTextArea(2,62);
		errorsPane = new JScrollPane(errorsArea);
		errorsPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
...
//		System.out.println(matDou[2][1]);
	...
	public void calculate(){
		...
		errorsArea.setText(helper.getErrors());
	}
